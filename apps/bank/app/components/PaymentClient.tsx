    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Complete your transaction</p>
        </div>
        ...
        {/* Back to App Link */}
        <div className="text-center mt-6">
          <a href={process.env.NEXT_PUBLIC_USER_APP_URL || 'http://localhost:3001'} className="text-indigo-600 hover:text-indigo-700 font-medium">
            ← Back to NexPay App
          </a>
        </div>
      </div>
